...
public class VentanaPrincipal implements ActionListener {
	 ...
	 * @param ctrl
	 */
	public VentanaPrincipal(Controller ctrl) {
		initialize();
		this.frame.pack();
		this.ctrl = ctrl;
		this.ctrl.run();
	...
	private <E> void creaPanelPlataforma() {
		...
		JCheckBox[] boxes = new JCheckBox[food.length]; // Each checkbox will
														// get a name of food
														// from food array.
	...
	private void creaPanelTienda() {
		...
		// LISTA PRODUCTOS
		String[] items = new String[] { "COD", "MINECRAFT", "GTA", "FIFA" };
		...
		String[] items2 = new String[] { "MINECRAFT", "GTA", "FIFA" };
